...
test("crear cartel", () => {
    ...
    expect (Luz.prototype.isPrototyprOf(cartel.matriz[0][0])).toBe(true);
    expect (Luz.prototype.isPrototyprOf(cartel.matriz[0][1])).toBe(true);
    expect (Luz.prototype.isPrototyprOf(cartel.matriz[1][0])).toBe(true);
    expect (Luz.prototype.isPrototyprOf(cartel.matriz[1][1])).toBe(true);
});
